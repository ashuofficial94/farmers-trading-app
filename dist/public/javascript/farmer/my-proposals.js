...
let state_input = document.querySelector("#location-state");
let city_input = document.querySelector("#location-city");
...
function fillCities(index = 0) {
    let cities = s_a[index].split("|");
    for (let city of cities) {
        let option = document.createElement("option");
        option.setAttribute("value", city);
        option.innerHTML = city;
        city_input.appendChild(option);
    }
}
